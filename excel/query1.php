...
$p=$datos["externa"][$servicio][$area]["6"]+$datos["externa"][$servicio][$area]["7"];
$d=$datos["externa"][$servicio][$area]["1"]+$datos["externa"][$servicio][$area]["2"]+$datos["externa"][$servicio][$area]["3"]+$datos["externa"][$servicio][$area]["4"];

$t=$datos["externa"][$servicio][$area]["5"]+$d+$p;
...
($datos["externa"][$servicio][$area]["1"]+
($datos["externa"][$servicio][$area]["2"]*2)+
($datos["externa"][$servicio][$area]["3"]*3)+
($datos["externa"][$servicio][$area]["4"]*4)+
($datos["externa"][$servicio][$area]["5"]*5)+
($datos["externa"][$servicio][$area]["6"]*6)+
($datos["externa"][$servicio][$area]["7"]*7))
/($t)),1);
