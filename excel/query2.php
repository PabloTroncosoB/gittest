...
if($servs == "todos"){
echo "$periodo,".getPregunta($servicio,"satiuc promotores").",".getSubpregunta($nivel).",".getOpcion($servicio).",4,1,$segmento,".$dord[$servicio][$nivel]["promotores"]."),<br>(";
echo "$periodo,".getPregunta($servicio,"satiuc detractores").",".getSubpregunta($nivel).",".getOpcion($servicio).",4,1,$segmento,".$dord[$servicio][$nivel]["detractores"]."),<br>(";
echo "$periodo,".getPregunta($servicio,"satiuc indice").",".getSubpregunta($nivel).",".getOpcion($servicio).",4,1,$segmento,".$dord[$servicio][$nivel]["indice"]."),<br>(";}
}
