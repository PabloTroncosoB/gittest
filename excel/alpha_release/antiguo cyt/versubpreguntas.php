...
$subpreguntas='id;texto;descripcion;orden';
$cuenta=0;
$comparapreguntas = null;
		...
		if($cadena[1] != false ){
			...
			$cuenta++;
			$subpreguntas=$subpreguntas."<br>".$sumasubpreguntas.";".$pregunta[1].";".$descripcion.";".$ordensubpreguntas;	
			$sumasubpreguntas++;
			}
			
		$comparapreguntas = $cadena[0];
		//id	texto	descripcion	orden
