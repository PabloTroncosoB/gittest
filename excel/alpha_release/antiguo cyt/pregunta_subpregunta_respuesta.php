...
$texto ="pregunta_id;opcion_id;periodo_id<br>";
include("id.php");
...
$comparapreguntas = null;
		...
		$elementos[$cuenta]=$sumapregunta.";".$respuesta.";".$periodo_id."<br>";
		$cuenta++;
}
...
$texto=$texto.$elementosfiltrados[$i];
}}
echo $texto;	  
 /*
	$conexion = mysql_connect("lauca.ing.puc.cl", "CETIUC_DB", "*****");
